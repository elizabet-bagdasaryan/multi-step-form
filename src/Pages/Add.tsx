...
function Add(){
  ...
  return(
    ...
    <div onClick={handleStorage} className={clickedStorage ? "flex border border-1 border-purple bg-lightgrey rounded-md p-2 w-full items-center justify-between mt-6":"flex border border-1 border-gbor rounded-md p-2 w-full items-center justify-between mt-6" }>
    <div className="flex items-center">
    ...
    <div onClick={handleProf} className={clickedProf ? "flex border border-1 border-purple bg-lightgrey rounded-md p-2 w-full items-center justify-between mt-6":"flex border border-1 border-gbor rounded-md p-2 w-full items-center justify-between mt-6" }>
    <div className="flex items-center">
